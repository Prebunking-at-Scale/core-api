...
class FeedbackService:
    ...
    async def submit_narrative_feedback(
        ...
        async with self.repo() as repo:
            ...
            feedback = await repo.submit_narrative_feedback(user_id, narrative_id, feedback_score)
    ...
    async def submit_claim_narrative_feedback(
        ...
        async with self.repo() as repo:
            ...
            # Only save to database if external API call succeeded
            feedback = await repo.submit_claim_narrative_feedback(user_id, claim_id, narrative_id, feedback_score)
